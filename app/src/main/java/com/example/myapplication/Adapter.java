...
public class Adapter extends RecyclerView.Adapter<Adapter.NoteViewHolder> {
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Note note) {
            ...
            red.setVisibility(note.tag == Tag.red ? View.VISIBLE : View.GONE);
            blue.setVisibility(note.tag == Tag.blue ? View.VISIBLE : View.GONE);
            green.setVisibility(note.tag == Tag.green ? View.VISIBLE : View.GONE);
